...
# ********** **********
# check the object of ColumnDataSource, to read keys and values
print(type(source))
print(source)
print(type(source.data))
print(source.data.keys())
print(source.data['Year'])
...
# ********** ********** ********** **********
https://campus.datacamp.com/courses/interactive-data-visualization-with-bokeh/basic-plotting-with-bokeh?ex=17
# ********** **********
...
# ********** ********** ********** **********
https://campus.datacamp.com/courses/interactive-data-visualization-with-bokeh/basic-plotting-with-bokeh?ex=18
# ********** **********
